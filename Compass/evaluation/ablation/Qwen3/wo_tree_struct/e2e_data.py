...
import sys
sys.path.append('/home/lym/PbCirculation/Compass/code/utils')
from dataloader import Dataloader
from prompt import generate_ablation_prompt
...
def main():
    TASK = "wo_tree_struct_E2EDataExtraction"
    timestamp = datetime.now().strftime("%m%d_%H%M")

    model_name = "/home/lym/data1/LLM-model/Qwen/Qwen3-8B"
    test_data_path = "/home/lym/PbCirculation/Compass/test_data/test_data3.0/test_data3.csv"
    mineru_dir = "/home/lym/PbCirculation/Compass/test_data/test_data3.0/mineru_output_3"
    true_csv_dir = "/home/lym/PbCirculation/Compass/test_data/test_data3.0/e2e_data_checked_3"

    output_dir = f"./results3/e2e_result_{timestamp}"
    ...
    with open(result_csv_path, 'w', encoding='utf-8', newline='') as csvfile:
        ...
        for idx, row in tqdm(test_data.iterrows(), total=len(test_data)):
            ...
            prompt = generate_ablation_prompt(TASK, title=title, abstract=abstract, tables=tables)
