...
def main():
    TASK = "wo_tree_struct_PaperClassification"
    ...
    output_dir = f"./results3/paper_result_{timestamp}"
    ...
    for idx, row in tqdm(test_data.iterrows(), total=len(test_data)):
        ...
        prompt = generate_ablation_prompt(task=TASK, title=title, abstract=abstract)
    ...
    metrics = calculate_metrics("PaperClassification", true_labels, predicted_labels)
