...
def main():
    TASK = "wo_tree_struct_TableClassification"
    ...
    output_dir = f"./results3/table_result_{timestamp}"
    ...
    for idx, row in tqdm(test_data.iterrows(), total=len(test_data)):
        ...
        for i, table in enumerate(table_data):
            ...
            prompt = generate_ablation_prompt(task=TASK, title=title,abstract=abstract,table_content=table_content)
    ...
    metrics = calculate_metrics("TableClassification", true_labels, predicted_labels)
