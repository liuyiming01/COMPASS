...
def kTree_paper_classification(model, tokenizer, title: str, abstract: str) -> Tuple[str, str, str, str]:
    ...
    """
    pb_related_prompt, classification_prompt = generate_prompt(task='knowledge_tree_PaperClassification',title=title,abstract=abstract)
...
def main():
    TASK = "knowledge_tree_PaperClassification"
